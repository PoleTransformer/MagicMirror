...
This is customized fork of MagicMirror, custom adapted for use with tablets. Adds MS Graph API support to fetch calendar information. Please configure the .env file in the base directory with secrets from Entra. DO NOT PUSH THIS TO GITHUB, KEEP IT IN .gitignore!!!

```
user="Application ID"
pass="Client secret value"
authority="https://login.microsoftonline.com/Directory (tenant) ID"
rooms="comma seperated list of email addresses for the meeting rooms"
